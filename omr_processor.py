...
# ─────────────────────────────────────────────────────────────────────────────
BUBBLE_RADIUS  = 15     # Radio de muestreo en píxeles
FILL_THRESHOLD = 0.07   # Fill mínimo (umbral bajo — el discriminador real es MIN_CONTRAST)
MIN_CONTRAST   = 0.040  # Diferencia mínima entre burbuja 1ra y 2da
